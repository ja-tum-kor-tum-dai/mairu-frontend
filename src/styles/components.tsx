...
export const textTitle = apply`text(sm:xl md:3xl lg:4xl center)`
export const textBase = apply`text(sm:base md:lg lg:xl)`
export const textSmall = apply`text(sm:xs md:base lg:xl)`
export const textInput = apply`${textBase} font-sans-serif`
export const textSubmit = apply`${textBase} text-center`
export const textNavbar = apply`${transitionText} hover:text-xl`
